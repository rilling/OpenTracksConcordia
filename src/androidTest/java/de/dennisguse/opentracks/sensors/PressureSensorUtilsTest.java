...
public class PressureSensorUtilsTest {
    ...
    public void altitudeChanges_none() {
        ...
        // Calibrating the barometric pressure for a simulated altitude of 1000 meters.
        // This method inverts the barometric pressure to altitude estimation based on the provided formula:
        // p(h) = p0 * (1 - 0.0065 * h / T0) ^ 5.255, where h is the altitude in meters.
        // The result represents a calibrated atmospheric pressure corresponding to the given simulated altitude.
        AtmosphericPressure firstSensorValue = PressureSensorUtils.calibrateBarometricPressure(sensorValues_hPa[0]);
    ...
    public void computeChanges_downhill() {
        ...
        for (float v : sensorValues_hPa) {
            ...
            if (altitudeChange != null) {
                ...
                altitudeLoss += altitudeChange.getAltitudeLossMeters();
